...
`;
    ...
    document
        ...
        .appendChild(staticRecordElement);
    ...
    `;
            ...
            function enterEditMode(recordElement) {
                ...
                const symptomsElement =
                    recordElement.querySelector(".record-list li");
            ...
            function saveChanges(recordElement) {
                const patientNameInput = recordElement.querySelector(
                    ".record-section-title input"
                );
                const symptomsInput = recordElement.querySelector(
